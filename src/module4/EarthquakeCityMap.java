...
public class EarthquakeCityMap extends PApplet {
	...
	private void printQuakes() {
		...
		for (Marker cm : countryMarkers) {
			...
			for (Marker ea : quakeMarkers) {
				EarthquakeMarker e = (EarthquakeMarker) ea;

				if (e.isOnLand) {
					String country = e.getStringProperty("country");
					// System.out.println(country+"G");
					if (name.equals(country)) {
						quakeC++;
					}
				}
			}
			System.out.println(name + ":" + quakeC);
		}

		int OceanQuakes = totalQuakes - quakeC;
