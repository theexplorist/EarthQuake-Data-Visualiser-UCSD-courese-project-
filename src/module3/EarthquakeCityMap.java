...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
		...
		if (offline) {
			...
			map = new UnfoldingMap(this, 190, 50, 750, 500, new OpenStreetMap.OpenStreetMapProvider());
